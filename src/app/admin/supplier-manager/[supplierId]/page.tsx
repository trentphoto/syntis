...
import { CalendarIcon, MailIcon, PhoneIcon, MapPinIcon, BuildingIcon, EditIcon, TrashIcon, ExternalLinkIcon, ShieldIcon, CreditCardIcon, PackageIcon, HomeIcon } from "lucide-react"
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <span className="font-mono bg-muted px-2 py-1 rounded">ID: {supplier.id}</span>
              <span>•</span>
